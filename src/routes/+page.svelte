...
>
	<div class="grid grid-cols-1 gap-6 md:grid-cols-6">
		<div class="col-span-4">
			<h1 class="text-[white] font-bold bg-[#82bb92] border-3 border-gray-700 p-1 my-3">Projects Collections Series</h1>
		...
		<div class="col-span-2">
			<h1 class="text-[white] font-bold bg-[#82bb92] border-3 border-gray-700 p-1 m-3 ">PiePosts</h1>
