...
<div class="bg-blue-500">
	<a
		href="\projects\gare-de-xyz"
		rel="noopener noreferrer"
		class=" p-5 font-medium text-blue-900 hover:underline dark:text-blue-800">Back</a
	>
</div>

<div class="grid grid-cols-1 gap-4 bg-blue-500 p-5 sm:grid-cols-2 md:grid-cols-3">
	{#each images as image, index}
		<div class="relative">
			<img src={image} alt="Image {index + 1}" class="h-auto w-full shadow-md" loading="lazy" />
		</div>
	{/each}
</div>
