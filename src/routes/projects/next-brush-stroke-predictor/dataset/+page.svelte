<script lang="ts">
	...
	const imageModules = import.meta.glob('/src/lib/image-collections/nbsp-images/*.{jpg,png}', {
		eager: true
...
<div class="grid grid-cols-1 gap-8 bg-blue-500 p-5 sm:grid-cols-1 md:grid-cols-3">
